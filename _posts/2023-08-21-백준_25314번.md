...
![25314 이미지](https://github.com/hoos007/hoos007.github.io/assets/113767998/b59e8110-c794-45b2-85cd-2ad119decf3f)
...
System.out.print("int");
```
우선 필요한 바이트 수를 4로 나눈 몫을 통해 몇개의 long이 필요한지 계산하고 for문을 사용해 필요한 수 만큼 long을 출력하도록 한 뒤, 마지막에 int를 출력한다.
